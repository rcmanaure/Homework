...
class Vehicle(models.Model):
    ...
    fuel_tank_size = models.DecimalField(max_digits=6, decimal_places=2, null=True)
    ...
    def get_distribution(self) -> list:
        ...
        partial_row, fullrows = math.modf(
            self.passengers / 2
    ...
    def validate_number_plate(number_plate) -> bool:
        ...
        # e.g: AA-12-34
        regex = r"^[A-Z][A-Z][\-][0-9][0-9][\-][0-9][0-9]$"
        match_plate = re.match(regex, number_plate)
        if match_plate:
            return True
        else:
            return False
